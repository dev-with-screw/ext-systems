...
CREATE TABLE cr_person (
	...
	passport_date date,
    sertificate_number varchar(10),
    sertificate_date date,
    PRIMARY KEY (person_id)
);

INSERT INTO public.cr_person(
    sur_name, given_name, patronymic, date_of_birth, passport_seria, passport_number, passport_date, sertificate_number, sertificate_date)
...
INSERT INTO public.cr_person(
    sur_name, given_name, patronymic, date_of_birth, passport_seria, passport_number, passport_date, sertificate_number, sertificate_date)
VALUES ('Васильева', 'Евгения', 'Павловна', '2016-01-11', null, null, null, '456123', '2016-01-19');

INSERT INTO public.cr_person(
    sur_name, given_name, patronymic, date_of_birth, passport_seria, passport_number, passport_date, sertificate_number, sertificate_date)
VALUES ('Васильев', 'Александр', 'Павлович', '2018-10-24', null, null, null, '456123', '2018-11-09');
